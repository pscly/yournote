...
```json
{
    ...
    "user_config": {
        ...
        "paired_user_config": {
            ...
            "word_count": 72001,
            "image_count": 26,
            "last_login_time": 1767854181,
            "ts": 1767808504,
            "paired_time": 1767614422
        },
        "general_config": {
            "report_abuse_reasons": [
                [
                    "politics",
                    "反动政治"
                ],
        ...
        "launch_page_config": {
            "image": {
                "id": 1,
                "image_url": "https://public-image-1251122880.cos.ap-guangzhou.myqcloud.com/observatory.jpg",
                "text": "Observatory",
                "text_color": "#fff8",
                "link": ""
            },
            "btn": {
                ...
                "bg_color": "#ddd",
                "color": "#888",
                "link": "https://wenjuan.feishu.cn/m/?t=sSnXEe4THIti-m8i9",
                "page": null,
                "page_param": null
            },
            "logo": {
                "image_url": "https://public-image-1251122880.cos.ap-guangzhou.myqcloud.com/logo2.png",
                "link": null
            },
            "show_ad": false,
            "freeze_time": 1
    ...
    "treehole_notifications": [],
    "random_diary": {
        "id": 4369498,
        "user": 460100,
        "createddate": "2018-03-27",
        "ts": 1522160268,
        "content": "  今天又是美好的一天啊，\n  该发生的也发生了，学习上也明白了一些问题，\n  唯一不开心的就是，整整一个晚自习我居然才记了6个单词\n import 进口\n input 输入\n random 随机的\n include 调用\n main 主要的\n print 打印\n\n晚自习我都在干嘛啊😅\n",
        "weather": "sunny",
        "mood": "happy",
        "mood_id": null,
        "mood_color": null,
        "title": "平常的一天",
        "space": "boy",
        "createdtime": 1522160075
    },
    "error": 0,
    "version": "2e6ddb83ba02935f4732c4cf898e1183"
}
```
...
diaries 是我的日记 (我的是每写一个就多一个)
diaries_paired  是对方的日记 (每公开一个，就会多一个字段)
